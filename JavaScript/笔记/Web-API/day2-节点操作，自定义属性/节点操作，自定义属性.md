...
element.getAttribute(’属性‘)    //获取属性值			element.setAttribute('属性','值')    //设置属性值		 elemen.removeAttribute('属性')	
...
![1551163384254](D:/JavaScript教程/笔记/wab API/4-笔记/images/1551163384254.png)
